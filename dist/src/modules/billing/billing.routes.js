...
router.post('/checkout', authenticateDashboard_1.authenticateDashboard, billing_controller_1.createCheckoutSession);
router.post('/portal', authenticateDashboard_1.authenticateDashboard, billing_controller_1.createPortalSession);
